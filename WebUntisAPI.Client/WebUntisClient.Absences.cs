...
namespace WebUntisAPI.Client
{
    partial class WebUntisClient
    {
        ...
        /// <param name="personId">Id of the person which absence is requested</param>
        ...
        /// </returns>
        public async Task<AbsenceData> GetAbsencesAsync(DateOnly startDate, DateOnly endDate,int personId, int excuseStatusId = -1, CancellationToken ct = default)
        {
            ...
            UriBuilder uriBuilder = new()
            {
                ...
                Query = $"startDate={startDate:yyyyMMdd}&endDate={endDate:yyyyMMdd}&studentId={personId}&excuseStatusId={excuseStatusId}"
            };
