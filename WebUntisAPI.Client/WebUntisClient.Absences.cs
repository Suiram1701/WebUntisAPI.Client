...
namespace WebUntisAPI.Client
{
    partial class WebUntisClient
    {
        ...
        /// </returns>
        public async Task<AbsenceData> GetAbsencesAsync(DateOnly startDate, DateOnly endDate, int excuseStatusId = -1, CancellationToken ct = default)
        {
            ...
            return JObject.Parse(responseString)["data"]!.ToObject<Models.AbsenceData>()!;
